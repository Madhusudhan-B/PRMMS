...
const prepareDataForExport = () => {
  return tags.value.map(user => {
    return {
      'ID': i++,
      'Date/Time': user.date ? moment(user.date, 'YYYY-MM-DD').format('YYYY-MMM-DD HH:mm') : '',
      'Staff ID': user.staff_id,
      'Staff Name': user.staff_name,
      'Department': user.department_name,
      'First In':  user.first_in ? moment(user.first_in, 'YYYY-MM-DD').format('YYYY-MMM-DD HH:mm') : '',
      'Last Out':  user.last_out ? moment(user.last_out, 'YYYY-MM-DD').format('YYYY-MMM-DD HH:mm') : '',
          ...
          <VTable>
            ...
            <tr
              ...
              >
                ...
                <td>
                <span>{{ moment(user.date, 'YYYY-MM-DD').format('DD-MMM-YY') }}</span>
                  <!-- <span >{{(user.date) ? moment(user.date , 'YYYY-MM-DD').format('YYYY-MMM-DD') : ''}}</span> -->
                </td>
                <td>
                ...
                <td>
                <span>{{ moment(user.first_in, 'YYYY-MM-DDTHH:mm:ssZ').format('DD-MMM-YY HH:mm') }}</span>
                  <!-- <span >{{(user.first_in) ? moment(user.first_in , 'YYYY-MM-DD').format('YYYY-MMM-DD HH:mm') : ''}}</span> -->
                </td>
                <td>
                <span>{{ moment(user.last_out, 'YYYY-MM-DDTHH:mm:ssZ').format('DD-MMM-YY HH:mm') }}</span>
                  <!-- <span >{{(user.last_out) ? moment(user.last_out , 'YYYY-MM-DD').format('YYYY-MMM-DD HH:mm') : ''}}</span> -->
                </td>
                <td>
