...
const dateRangeValue = (dateRangeString) =>{
  //const dateRangeString = '2023-07-18 to 2023-07-27';

// Split the date range string into start and end dates
const [startDateString, endDateString] = dateRangeString.split(' to ');

// Convert the date strings to Date objects using Moment.js
const startDate = moment(startDateString, 'YYYY-MM-DD').format('YY-MM-DD');
const endDate = moment(endDateString, 'YYYY-MM-DD').format('YY-MM-DD');
console.log(startDate); // Output: Tue Jul 18 2023 00:00:00 GMT+0000 (Coordinated Universal Time)
console.log(endDate); // Output: Thu Jul 27 2023 00:00:00 GMT+0000 (Coordinated Universal Time)
