...
const handlePerPageChange = (newPerPage) => {
  updatePage(currentPage.value, newPerPage);
};
...
const exportToPDF = () => {
  let filename = "Entry/Exit-Report.pdf";
...
<!-- </VForm> -->
          ...
          <VCol cols="6" sm="4">
            ...
            <VCol cols="6" sm="6"> 
          <h3 class="" style="">Rolling Stocks Entry/Exit Report</h3>
          </VCol>
        </VRow>
          ...
          <VTable>
            ...
            <tr
              ...
              >
                ...
                <span>{{ (user.in_time) ? moment(user.in_time).format('YYYY:MMM:DD HH:mm:ss') : '' }}</span>
                </td>
                <td>
                <span>{{ (user.in_time) ? moment(user.in_time).format('YYYY:MMM:DD HH:mm:ss') : '' }}</span>
                </td>
         ...
         <VCardText class="d-flex align-center flex-wrap justify-space-between gap-4 py-3 px-5">
              ...
              <VSelect v-model="rowPerPage" @change="handlePerPageChange" density="compact" variant="outlined" :items="[10, 20, 30, 50]" />
            </div>
