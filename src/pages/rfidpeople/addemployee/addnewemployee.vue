<script setup>
    ...
    // import PreviewDialogForm from '@/views/apps/rfidpeople/list/PreviewDialogForm.vue';
...
<template>
  <VCard>
    <VCardText>
    <h3 class="title-header"> {{$t('Staff - Create')}}</h3>
    </VCardText>
    <VSpacer />
    <VCardText >
        <!-- ?? Form -->
  ...
  >
    ...
    <template #activator="{ props }">
      <VBtn v-bind="props" color="success" >
        Preview
      </VBtn>
    </template>
                ...
                <v-card>
                  ...
                  <VCol cols="12">
                      ...
                      <div id="cropped_result" style="text-align: center;">
                        <img :src="cam_photo" width="250" height="250" style="object-fit:contain" id="cam" />
                      </div>
                  </VCol>
...
<VCardText>
  ...
  <VBtn type="submit" class="me-3" style="margin-left:10px !important">
                            Create
                        </VBtn>
                        <VBtn
