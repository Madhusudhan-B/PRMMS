...
<template>
  <VCard>
    <VCardText>
    <h3 class="title-header">{{$t('Employee - Update')}}</h3>
    </VCardText>
    <VSpacer />
    <VCardText>
        <!-- ?? Form -->
  ...
  <img :src="display_image ? display_image : cam_photo" id="output" width="200" />
        ...
        <VCardText>
            ...
            <VTextField v-model="employee_id" :rules="[requiredValidator]" label="Employee ID" />
              ...
              <VTextField v-model="first_name" :rules="[requiredValidator,alphaValidator,  regexValidator(first_name, '^.{1,25}$')]" label="First Name" />
              </VCol>

              <VCol cols="6">
              <VTextField v-model="last_name" :rules="[requiredValidator,alphaValidator, regexValidator(last_name, '^.{1,25}$')]" label="Last Name" />
              </VCol>
              ...
              <VCol cols="6"  class="think">
              <VTextField v-model="designation" :rules="[requiredValidator, regexValidator(designation, '^.{1,10}$')]" label="Designation" />
              </VCol>
