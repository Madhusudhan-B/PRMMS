    ...
    refForm.value?.validate().then(({ valid }) => {
        if (valid) {
          ...
          selectedModules.forEach(element => {
           ...
           var filterdata= moduleselected.value.filter(module => module.module.id === element.module.id )
      ...
      <VCard >
        <VDivider />
          ...
          <VCardText class="d-flex flex-wrap py-4 gap-4">
              ...
              <h3 class="title-header">Abilities - Create</h3>
          ...
          <VForm ref="refForm" v-model="isFormValid" @submit.prevent="onSubmit">
            ...
            <VCardText style="color:#5c5c3d">Access Type</VCardText>
             ...
             <VExpansionPanels  v-model="panel" multiple>
                  ...
                  >
                    <VExpansionPanelTitle   @click="handleClick" >
                            ...
                            <div class="demo-space-x" v-if="submodule.short_code!=tag.short_code ">
                              <ul>
                                  <li   v-for="(data, index) in submodule.access_config.split(',')"  :key="index" style="float:left;">
                                    ...
                                    class="ml-2 "
                                    :label="data"
                                    :id="submodule.short_code+'-'+submodule.id+'-'+data+'-'+tag.short_code"                                   
                                    :value="submodule.short_code+'-'+submodule.id+'-'+data+'-'+tag.short_code"
                                  />
