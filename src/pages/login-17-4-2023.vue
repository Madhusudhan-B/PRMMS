...
const msalConfig = {  auth: {
    ...
    // grant_type:'password',
    // client_id:'093daaf3-0ca0-450e-970a-50e5f486e2b3',
     name:'test@sivakrishnamudunuru.onmicrosoft.com',
    // password:'Mudunuru@123',
    // scope:['user.read'],
    client_secret:'lVU8Q~a5K5hhUkXeWn~eVac9o~JOxyFQTaxGycYT',
    authority: 'https://sivakrishnamudunuru.onmicrosoft.com/81e5b5d0-3730-45af-abf6-43eb4cfdb184',

    redirectUri: 'https://omp.mudunuru.com/' // replace with your app's redirect URI  }
}
}
...
const login = () => {
  ...
  msalInstance.loginPopup().then(response => {
        ...
        console.log(response);        // do something with the user's access token
      })
