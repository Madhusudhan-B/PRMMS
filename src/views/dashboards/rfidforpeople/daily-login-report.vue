...
console.log("Daily Login report loading .. ");
...
const fetchWorkshop = async ( offset, search, isExport = false) => {
  try {  
    console.log("fetchWorkshop() invoked");
...
const exportToPDF = async () => {
  console.log("Daily Login report function called.. ");
  fetchWorkshop();
  let filename = "Daily-Login-report.pdf";
