...
console.log('props ws3')
console.log(props.perimeter)
const series = [
parseInt(props.perimeter.active_count),
parseInt(props.perimeter.inactive_count),
]
console.log(series)
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              fontFamily: 'Public Sans',
              formatter() {
                return parseInt(props.perimeter.camera_count)
              },
            },
          },
        },
