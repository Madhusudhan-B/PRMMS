...
export default defineConfig({
    ...
    plugins: [
        ...
        Components({
            dirs: ['src/@core/components', 'src/views/dashboards'],
            dts: true,
        }),
        AutoImport({
            eslintrc: {
    ...
    resolve: {
        alias: {
            ...
            'apexcharts': fileURLToPath(new URL('node_modules/apexcharts-clevision',
                import.meta.url)),
                'vue-qrcode': fileURLToPath(new URL('node_modules/vue-qrcode/lib/index.js',
                import.meta.url)),
               
                    // Add alias for vue-qrcode if necessary
    ...
    build: {
        ...
        rollupOptions: {
            external: ['qrcode'], // Add 'qrcode' to the list of external modules
          },
    },
    optimizeDeps: {
        exclude: ['vuetify', 'html2pdf.js'],
        entries: [
            './src/**/*.vue',
        ],
    },
